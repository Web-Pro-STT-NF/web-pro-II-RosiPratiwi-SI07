...
<body>
  ...
  <?php
  $mahasiswa = [
    $mhs1 = new Mahasiswa('00001', 'Rosa', 'SI', '2012', 3.8),
    $mhs2 = new Mahasiswa('00002', 'Risda', 'TI', '2012', 3.9),
    $mhs3 = new Mahasiswa('00003', 'Nala', 'SI', '2010', 3.46),
    $mhs4 = new Mahasiswa('00004', 'Rosi', 'SI', '2010', 3.2),
  ];
  ?>
